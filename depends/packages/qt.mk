...
$(package)_download_path=http://ftp.jaist.ac.jp/pub/qtproject/archive/qt/5.9/5.9.7/submodules/
...
$(package)_config_opts_arm_linux += -platform linux-g++ -xplatform epgc-linux-g++
$(package)_config_opts_i686_linux  = -xplatform linux-g++-32
$(package)_config_opts_x86_64_linux = -xplatform linux-g++-64
$(package)_config_opts_aarch64_linux = -xplatform linux-aarch64-gnu-g++
$(package)_config_opts_riscv64_linux = -platform linux-g++ -xplatform epgc-linux-g++
...
define $(package)_preprocess_cmds
  ...
  cp -r qtbase/mkspecs/linux-arm-gnueabi-g++ qtbase/mkspecs/epgc-linux-g++ && \
  sed -i.old "s/arm-linux-gnueabi-/$(host)-/g" qtbase/mkspecs/epgc-linux-g++/qmake.conf && \
