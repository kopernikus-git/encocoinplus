...
extern UniValue setzepgseed(const UniValue& params, bool fHelp);
extern UniValue getzepgseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzepg(const UniValue& params, bool fHelp);
extern UniValue dzepgstate(const UniValue& params, bool fHelp);
