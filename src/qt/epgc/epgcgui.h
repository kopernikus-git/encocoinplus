...
#ifndef EPGC_CORE_NEW_GUI_EPGCGUI_H
#define EPGC_CORE_NEW_GUI_EPGCGUI_H
...
/**
  EPGC GUI main class. This class represents the main window of the EPGC UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class EPGCGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit EPGCGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~EPGCGUI();
...
#endif //EPGC_CORE_NEW_GUI_EPGCGUI_H
