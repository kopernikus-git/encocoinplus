...
#include "qt/epgc/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(EPGCGUI* parent);
    ~SendWidget();
...
private slots:
    void onEPGSelected(bool _isEPG);
    void onSendClicked();
...
private:
    ...
    bool sendZepg(QList<SendCoinsRecipient> recipients);
