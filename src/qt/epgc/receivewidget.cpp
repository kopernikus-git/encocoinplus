...
#include "qt/epgc/forms/ui_receivewidget.h"
...
#include "qt/epgc/addressholder.h"
...
ReceiveWidget::ReceiveWidget(EPGCGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive EPG."));
