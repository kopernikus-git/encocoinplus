...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, EPGCGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, EPGCGUI *gui, double posX = 3);
