...
#include "qt/epgc/furabstractlistitemdelegate.h"
#include "qt/epgc/txviewholder.h"
#include "qt/epgc/tooltipmenu.h"
#include "qt/epgc/sendmultirow.h"
#include "qt/epgc/coldstakingmodel.h"
#include "qt/epgc/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(EPGCGUI* parent);
    ~ColdStakingWidget();
