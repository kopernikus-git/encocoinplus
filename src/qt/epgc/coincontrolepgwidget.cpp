...
#include "qt/epgc/coincontrolepgwidget.h"
#include "qt/epgc/forms/ui_coincontrolepgwidget.h"

CoinControlEpgWidget::CoinControlEpgWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlEpgWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select EPG Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("EPG");
    ...
    ui->labelValueAfter->setText("0.00 EPG");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 EPG");
    ui->labelValueFee->setText("0.00 EPG");
...
CoinControlEpgWidget::~CoinControlEpgWidget()
{
    delete ui;
}
