...
#include "qt/epgc/forms/ui_navmenuwidget.h"
#include "qt/epgc/epgcgui.h"
#include "qt/epgc/qtutils.h"
#include "clientversion.h"
#include "optionsmodel.h"

NavMenuWidget::NavMenuWidget(EPGCGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    btns = {ui->btnDashboard, ui->btnSend, ui->btnReceive, 
	    ui->btnAddress, 
            //ui->btnPrivacy, 
            ui->btnMaster, 
            ui->btnColdStaking, ui->btnSettings, ui->btnColdStaking};
