...
#include "qt/epgc/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(EPGCGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsSignMessageWidgets)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText(tr("Enter a EPGC address or contact label"));
