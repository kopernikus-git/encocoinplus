...
#include "qt/epgc/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/epgc/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(EPGCGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to EPGCGUI::handleRestart()
