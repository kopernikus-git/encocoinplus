...
#include "qt/epgc/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/epgc/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(EPGCGUI* _window, QWidget *parent) :
