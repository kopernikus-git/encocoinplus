...
#include "qt/epgc/settings/settingsnetworkwidget.h"
#include "qt/epgc/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/epgc/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(EPGCGUI* _window, QWidget *parent) :
