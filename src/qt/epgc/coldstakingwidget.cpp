...
#include "qt/epgc/coldstakingwidget.h"
#include "qt/epgc/forms/ui_coldstakingwidget.h"
#include "qt/epgc/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/epgc/requestdialog.h"
#include "qt/epgc/tooltipmenu.h"
#include "qt/epgc/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(EPGCGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your EPGs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept EPG delegation / Delegate EPG"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select EPG outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 EPG" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
