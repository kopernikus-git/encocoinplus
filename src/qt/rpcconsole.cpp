                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzEPGPathCustom = GetArg("-zepgbackuppath", "");
    ...
    if(!strzEPGPathCustom.empty()) {
        ui->wallet_customzepgbackuppath->setText(QString::fromStdString(strzEPGPathCustom));
        ui->wallet_customzepgbackuppath_label->setVisible(true);
        ui->wallet_customzepgbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzEPGPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the EPGC RPC console.") + "<br>" +
