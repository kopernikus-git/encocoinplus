...
/* Epgc GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "EPGC"
#define QAPP_ORG_DOMAIN "epgc.org"
#define QAPP_APP_NAME_DEFAULT "EPGC-Qt"
#define QAPP_APP_NAME_TESTNET "EPGC-Qt-testnet"
