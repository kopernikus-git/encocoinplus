...
#ifndef EPGC_ZEPGWALLET_H
#define EPGC_ZEPGWALLET_H
...
public:
    CzEPGWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZEPG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZEPG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
