...
/** No amount larger than this (in EPG) is valid in a single UTXO.
 *
 * Note that this constant is *not* the total money supply, which in EPGC
 ...
 */
static const CAmount MAX_MONEY_OUT = 40000000 * COIN;
