...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_19_DEV_FEE,                        4070908800ULL), // OFF // Added for multi-tier architecture
};
...
// EPGC: on startup load spork values from previous session if they exist in the sporkDB
