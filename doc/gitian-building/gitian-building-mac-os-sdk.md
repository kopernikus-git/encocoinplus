...
The script [extract-osx-sdk.sh](https://github.com/epgc-project/epgc/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
epgc/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/epgc-project/epgc/blob/master/doc/README_osx.md) for troubleshooting tips.