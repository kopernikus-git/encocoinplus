...
RESOURCES += src/qt/epgc.qrc src/qt/epgc_locale.qrc

TRANSLATIONS += src/qt/locale/epgc_bg.ts \
                src/qt/locale/epgc_de.ts \
                src/qt/locale/epgc_en.ts \
                src/qt/locale/epgc_es.ts \
                src/qt/locale/epgc_fi.ts \
                src/qt/locale/epgc_fr.ts \
                src/qt/locale/epgc_it.ts \
                src/qt/locale/epgc_ja.ts \
                src/qt/locale/epgc_pl.ts \
                src/qt/locale/epgc_pt.ts \
                src/qt/locale/epgc_ru.ts \
                src/qt/locale/epgc_sk.ts \
                src/qt/locale/epgc_sv.ts \
                src/qt/locale/epgc_vi.ts \
                src/qt/locale/epgc_zh_CN.ts \
                src/qt/locale/epgc_zh_TW.ts
