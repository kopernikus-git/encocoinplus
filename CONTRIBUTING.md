Contributing to EPGC Core
============================

The EPGC Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/epgc-project/epgc/blob/master/doc/translation_process.md)
...
The following applies to code changes to the EPGC Core project, and is not to be
confused with overall EPGC Network Protocol consensus changes.

Whether a pull request is merged into EPGC Core rests with the project merge
...
Patches that change EPGC consensus rules are considerably more involved than
...
Where a patchset proposes to change the EPGC consensus, it must have been
...
The project leader is the release manager for each EPGC Core release.
